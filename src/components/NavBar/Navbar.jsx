                        ...
                        <div className='modal-box' onClick={(e) => e.stopPropagation()}>
                            <div className='modal-content'>
                                ...
                                <div className='info-perfil _efect'>
                                    <a className='' href='#'><i className='pi pi-cog' style={{ marginRight: '10px' }}></i>Configurar Perfil</a>
                                </div>
                                <div className='info-perfil _efect _themes' onClick={toggleModalThemes}>
                                    <a className='' href='#'><i className='pi pi-palette' style={{ marginRight: '10px' }}></i>Temas<i className='pi pi-angle-right _row' style={{ marginLeft: '90px' }}></i></a>
                                    {isOpenThemes && (
                                ...
                                <div className='info-perfil _efect' onClick={() => navigate('/')}>
                                    <a className='' href='#'><i className='pi pi-sign-out' style={{ marginRight: '10px' }}></i>Cerrar Sesión</a>
                                </div>
                            </div>
                        </div>
                    </div>
